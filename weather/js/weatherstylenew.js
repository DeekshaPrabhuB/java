    ...
    xhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
        ...
        for(let i=0;i<7;i++){
          ...
          console.log(a.query.results.channel.item.forecast[i]);
          ...
          if(textvalue==("Scattered Thunderstorms")||("Thunderstorms"))
          {
            var imglogo=document.getElementById(arr[i]);
          ...
          if(textvalue=="Mostly Cloudy")
          {
            var imglogo=document.getElementById(arr[i]);
            console.log(imglogo)
            imglogo.style.background="url('images/weather-icons_20180813_090711714.jpg')35% 15%";
          }
          if(textvalue=="Cloudy")
          {
            var imglogo=document.getElementById(arr[i]);
